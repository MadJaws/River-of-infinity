                ...
                /*  if ((direction == "clockWise 1.2") || (direction == "counterClockWise 2.4") || (direction == "river 3.2" ))      
                  {
                      ...
                      riverMap[x, y] = 1;     // 1 - в данной €чейке находитс€ река
                      ...
                      y += 4;         //ѕереходим в следующую €чейку дл€ продолжени€ реки

                      if ((riverMap[x - 4, y] == 2) && (riverMap[x + 4, y] == 2))             //провер€ем в какую сторону можно продолжить реку
                      {
                          direction = "river 3.2";                
                      }
             ...
             if ((direction == "clockWise 1.1")  || (direction == "river 3.3"))                    //   || (direction == "counterClockWise 2.1") 
                {
                    ...
                    riverMap[x, y] = 1;     // 1 - в данной €чейке находитс€ река
                        ...
                        switch (direction)
                        {
                            case "clockWise 1.1":
                                if ((x <= Width - 5) && (y >= 4))
                                {
                                    riverMap[x, y - 4] = 2;        // 2 - в данной €чейке река быть не может
                                    riverMap[x + 4, y] = 2;
                                }
                                else if (x <= Width - 5)
                                {
                   ...
                   /* if ((riverMap[x - 4, y] == 2) && (riverMap[x, y - 4] == 2))             //провер€ем в какую сторону можно продолжить реку
                    {
